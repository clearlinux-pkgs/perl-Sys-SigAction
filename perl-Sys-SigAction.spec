...
Version  : 0.24
Release  : 29
URL      : https://cpan.metacpan.org/authors/id/L/LB/LBAXTER/Sys-SigAction-0.24.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/L/LB/LBAXTER/Sys-SigAction-0.24.tar.gz
...
%prep
%setup -q -n Sys-SigAction-0.24
cd %{_builddir}
tar xf %{_sourcedir}/libsys-sigaction-perl_0.23-1.debian.tar.xz
cd %{_builddir}/Sys-SigAction-0.24
mkdir -p deblicense/
cp -r %{_builddir}/debian/. %{_builddir}/Sys-SigAction-0.24/deblicense/
